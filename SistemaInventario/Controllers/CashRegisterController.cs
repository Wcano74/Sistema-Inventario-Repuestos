...
namespace SistemaInventario.Controllers
{
    ...
    public class CashRegisterController : Controller
    {
        ...
        public CashRegisterController(ApplicationDbContext context, SistemaInventario.Services.IConfigurationService configService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                TempData["Error"] = "El rol Bodeguero no tiene acceso al módulo de caja.";
        ...
        public async Task<IActionResult> Close(int? id)
        {
            ...
            // Only the owner or an Admin can close a cash register
            var currentUserId = _context.Users.FirstOrDefault(u => u.UserName == User.Identity.Name)?.Id;
            if (!User.IsInRole("Admin") && cashRegister.UserId != currentUserId)
            {
                TempData["Error"] = "Solo puedes cerrar tu propia caja.";
                return RedirectToAction(nameof(Index));
            }
