...
public class HomeController : Controller
{
    ...
    private readonly SistemaInventario.Data.ApplicationDbContext _context;
    private readonly SistemaInventario.Services.IConfigurationService _configService;
    private readonly Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> _userManager;

    public HomeController(ILogger<HomeController> logger, SistemaInventario.Data.ApplicationDbContext context, SistemaInventario.Services.IConfigurationService configService, Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> userManager)
    {
        _logger = logger;
        _context = context;
    ...
    public async Task<IActionResult> Index()
    {
        ...
        {
            var defaultPage = await _configService.GetConfigurationAsync("Bodeguero_DefaultPage", "productos");
            if (defaultPage != "Home")
            {
        ...
        var viewModel = new SistemaInventario.Models.ViewModels.DashboardViewModel();
        ...
        try 
        {
            ...
            {
                viewModel.WeeklySales.Add(new SistemaInventario.Models.ViewModels.WeeklySalesResult
                {
            ...
            {
                viewModel.CategoryDistribution.Add(new SistemaInventario.Models.ViewModels.CategoryDistributionResult
                {
