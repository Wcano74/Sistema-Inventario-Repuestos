...
namespace SistemaInventario.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        public SalesController(ApplicationDbContext context, SistemaInventario.Services.IConfigurationService configService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(DateTime? startDate, DateTime? endDate, string period = "day")
        {
            ...
            {
                TempData["Error"] = "El rol Bodeguero no tiene acceso al módulo de ventas.";
        ...
        public async Task<IActionResult> Create()
        {
            if (User.IsInRole("Bodeguero"))
            {
                TempData["Error"] = "El rol Bodeguero no tiene acceso al punto de venta.";
                return RedirectToAction("Index", "Products");
            }
