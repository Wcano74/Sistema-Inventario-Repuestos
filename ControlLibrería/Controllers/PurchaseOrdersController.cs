...
namespace ControlLibrería.Controllers
{
    ...
    public class PurchaseOrdersController : Controller
    {
        ...
        public PurchaseOrdersController(ApplicationDbContext context, Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> userManager, ControlLibrería.Services.IConfigurationService configService)
        {
            _context = context;
