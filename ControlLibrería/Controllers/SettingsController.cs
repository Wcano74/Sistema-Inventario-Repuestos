...
using ControlLibrería.Services;
...
namespace ControlLibrería.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                // General
                LibraryName = await _configService.GetConfigurationAsync("LibraryName", "Control Librería"),
                LibraryAddress = await _configService.GetConfigurationAsync("LibraryAddress", ""),
                LibraryPhone = await _configService.GetConfigurationAsync("LibraryPhone", ""),
                LibraryNIT = await _configService.GetConfigurationAsync("LibraryNIT", "C/F"),
        ...
        public async Task<IActionResult> Index(SystemSettingsViewModel model)
        {
            ...
            {
                // General
                await UpdateConfig("LibraryName", model.LibraryName);
                await UpdateConfig("LibraryAddress", model.LibraryAddress);
                await UpdateConfig("LibraryPhone", model.LibraryPhone);
                await UpdateConfig("LibraryNIT", model.LibraryNIT);
