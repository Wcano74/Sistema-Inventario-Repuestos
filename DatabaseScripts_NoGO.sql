...
-- =============================================
-- Migration: AddReportProcedures
-- NOTE: Los stored procedures requieren ser ejecutados por separado.
-- Ejecuta cada CREATE PROCEDURE en un bloque individual.
-- =============================================
...
UPDATE AspNetUsers SET IsActive = 1 where UserName = 00001;
